...
inputs = [len(n_ten), len(n_hundred), len(n_oneThousand), len(n_tenThousand), len(n_hundredThousand),
          len(n_hundredThousand), len(n_oneMillion)]
cycles = 15  # implies the cycles of test of each input
...
def quickSortTest_firstPivot():
    quickSort_firstPivotInputs = ['q.quickSort(n_ten, 0, len(n_ten) - 1, fp)',
                                  'q.quickSort(n_hundred, 0, len(n_ten) - 1, fp)',
                                  'q.quickSort(n_oneThousand, 0, len(n_ten) - 1, fp)',
                                  'q.quickSort(n_tenThousand, 0, len(n_ten) - 1, fp)',
                                  'q.quickSort(n_hundredThousand, 0, len(n_ten) - 1, fp)',
                                  'q.quickSort(n_oneMillion, 0, len(n_ten) - 1, fp)']
    print()
...
def quickSortTest_middlePivot():
    quickSort_middlePivotInputs = ['q.quickSort(n_ten, 0, len(n_ten) - 1, mp)',
                                   'q.quickSort(n_hundred, 0, len(n_ten) - 1, mp)',
                                   'q.quickSort(n_oneThousand, 0, len(n_ten) - 1, mp)',
                                   'q.quickSort(n_tenThousand, 0, len(n_ten) - 1, mp)',
                                   'q.quickSort(n_hundredThousand, 0, len(n_ten) - 1, mp)',
                                   'q.quickSort(n_oneMillion, 0, len(n_ten) - 1, mp)']
    print()
...
def quickSortIterativeTest_randomPivot():
    quickSort_randomPivotInputs = ['q.quickSort(n_ten, 0, len(n_ten) - 1, rp)',
                                   'q.quickSort(n_hundred, 0, len(n_ten) - 1, rp)',
                                   'q.quickSort(n_oneThousand, 0, len(n_ten) - 1, rp)',
                                   'q.quickSort(n_tenThousand, 0, len(n_ten) - 1, rp)',
                                   'q.quickSort(n_hundredThousand, 0, len(n_ten) - 1, rp)',
                                   'q.quickSort(n_oneMillion, 0, len(n_ten) - 1, rp)']
    print()
